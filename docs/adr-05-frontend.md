...
| **UI Component Engine** | **Svelte** | 5.x (Runes mode) | Ultra-lightweight reactive islands ([KodexBar.svelte](../src/components/KodexBar.svelte), [SyvInput.svelte](../src/components/SyvInput.svelte)). |
