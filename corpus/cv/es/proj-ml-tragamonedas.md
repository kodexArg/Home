...
Sobre la base de datos de juego del Casino de Mendoza, Gabriel construyó modelos de clasificación y analítica predictiva con Python, pandas, TensorFlow, matplotlib y PostgreSQL. Es parte del mismo trabajo que sostuvo los dashboards de BI de esa etapa.
