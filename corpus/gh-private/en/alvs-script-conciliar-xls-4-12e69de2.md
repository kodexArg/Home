...
### P3 — Orphan cobranza residue extraction - **Who hurts:** Operators who must also identify cobranza rows that were never tied to any Mercado Pago operation in the export window. - **Pain today:** Focusing only on Mercado Pago leaves "extra" cobranza entries invisible unless a second manual pass is done. - **How this repo answers:** After matching, extract_non_conciliated pulls rows from each cobranza DataFrame where Conciliado remained false, producing cobranzas_km1151_residuo.xlsx and cobranzas_bovedas_residuo.xlsx alongside the main conciliacion_result.xlsx. - **Out of scope:** Reverse-matching Planilla 1 orphans; merging residue files across periods; alerting or ticketing.
