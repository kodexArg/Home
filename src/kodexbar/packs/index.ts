...
import { PLATZI_PACK } from './platzi';

export const PACKS: readonly KnowledgePack[] = [CV_PACK, GH_PRIVATE_PACK, GH_PUBLIC_PACK, IDENTITY_PACK, INTERESTS_PACK, PLATZI_PACK];
