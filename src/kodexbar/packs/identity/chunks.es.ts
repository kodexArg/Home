...
const DEFS: ChunkDef[] = [
	{
		...
		text: `¿Cuándo nació Gabriel? ¿Qué edad tiene? ¿Cuántos años tiene? Nació el 4 de abril de 1978 en Mendoza, Argentina. Hoy tiene ${computeGabrielCavedalAgeInYears()} años.`,
	...
	},
	{
		...
		text: `¿Cuál es el nombre completo de Gabriel? ¿Cuál es su nombre legal? ¿De dónde es Gabriel Cavedal? Su nombre completo y legal es Gabriel Alejandro Cavedal Arce. Es de Mendoza, Argentina.`,
