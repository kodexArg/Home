...
const DEFS: ChunkDef[] = [
	{
		...
		text: `When was Gabriel born? How old is he? What is his age? He was born on April 4, 1978, in Mendoza, Argentina. He is currently ${computeGabrielCavedalAgeInYears()} years old.`,
	...
	},
	{
		...
		text: `What is Gabriel's full name? What is his legal name? Where is Gabriel Cavedal from? His full legal name is Gabriel Alejandro Cavedal Arce. He is from Mendoza, Argentina.`,
