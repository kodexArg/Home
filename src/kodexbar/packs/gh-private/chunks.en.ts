...
const DEFS: ChunkDef[] = [
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | CLI-first configuration for the ALVS Data Lakehouse on Microsoft Fabric, with SharePoint Online as the file source. | | Audience | ALVS data engineers, operators, and AI agents working on Fabric lakehouse setup; kodexArg maintainers with access to the private repo. |`,
		related: [],
		tags: ["alvs-fabric-config","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `### P3 — Agent-ready project context for Fabric/SharePoint work - **Who hurts:** AI coding agents dispatched to configure ALVS infrastructure without domain context. - **Pain today:** Agents lack a concise mission statement, integration path, skill list, and MCP configuration to operate effectively on Azure/Fabric/SharePoint tasks. - **How this repo answers:** provides agent context (goal, chosen path, skills, rules). wires Azure MCP into the Grok session. README lists installed skills ( , , , Azure deploy/storage/prepare/diagnostics). - **Out of scope:** No or vault present in the tree (scanned; not found). Agent skills themselves live outside the repo under .`,
		related: [],
		tags: ["alvs-fabric-config","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `# AMESUP institutional website > **Problem thesis (required):** AMESUP (Asociación Mutual de Empleados de Sindicatos Unidos y Privados) needed a new public-facing web presence to replace legacy sites and brochures-only outreach. This repository delivers a production Angular single-page application: a conversion-oriented landing page for Mendoza public-sector employees seeking personal loans (up to five million ARS), subsidies, convenios, and membership benefits — deployed as static files on AWS Amplify with analytics via Google Tag Manager.`,
		related: [],
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Mobile-first institutional landing SPA for a Mendoza mutual, optimized for loan lead capture and WhatsApp handoff. | | Audience | Mendoza public-sector employees and retirees (target borrowers), AMESUP marketing/commercial staff, and internal developers maintaining the site. |`,
		related: [],
		tags: ["amesup-com-ar","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | A specification-driven, read-only Python API that transforms DEBO MSSQL rows into internal JSON endpoints for YPF station fuel sales and accounts-receivable workflows. | | Audience | Internal operators at KM 1107 stations (commercial, collections, admin); AI coding agents following and the BDD→TDD→BUILD chain; future PydanticAI tool consumers (post-MVP). |`,
		related: [],
		tags: ["api-python-debo","github","private","high","summary"],
		visibility: "private",
		importance: "high",
	...
	},
	{
		...
		text: `## 3. Product / idea The central idea is an **API facade** — not a protocol proxy. The service **reads** DEBO, **applies business rules**, and **publishes JSON** for internal consumers. It is the query side of a lightweight CQRS split: DEBO remains authoritative for writes; this service is read-only.`,
		related: [],
		tags: ["api-python-debo","github","private","high","summary"],
		visibility: "private",
		importance: "high",
	...
	},
	{
		...
		text: `# AppRunner Test 2 > **Problem thesis (required):** kodexArg needs a **private, throwaway-but-real** Django application that deploys on **AWS App Runner's native Python 3.11 runtime** — no containers — while exercising the full AWS peripheral stack (RDS Postgres, S3, CloudFront, Secrets Manager). The repo is both a **deployment recipe** ( + ) and an **integration test harness** that aborts startup if configuration, connectivity, or S3 write/read checks fail. It is not a production product; it is the proving ground for ALVS-style Django hosting patterns before auth, API, and modern frontend work land.`,
		related: [],
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Minimal Django 3.11 app deployed on AWS App Runner with RDS, S3/CloudFront, and Secrets Manager — gated by startup integration tests. | | Audience | kodexArg operators and backend engineers validating AWS App Runner for Django; future maintainers extending ALVS infrastructure patterns; agents needing context on the App Runner + Django stack choice. |`,
		related: [],
		tags: ["apprunnertest2","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 3. Product / idea The repository is a **single Django project** ( ) with one domain app ( ) and a shared template layer under . Mental model: The home page ( ) is a minimal testing shell linking to the DB health check. There is no user-facing product beyond proving infrastructure works.`,
		related: [],
		tags: ["apprunnertest2","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | The most powerful and modular stable diffusion GUI, API and backend with a graph/nodes interface. | | Audience | ML practitioners, SD hobbyists, pipeline engineers, and integrators who want fine-grained control over diffusion workflows; operators running local GPU or CPU inference servers; authors of custom node extensions. | The copy tracks the upstream ComfyUI codebase (GPL-3.0, README and still reference the original author). GitHub metadata shows it is not registered as a fork ( ) but content and structure match the canonical ComfyUI application. Last remote activity on the org mirror was August 2024.`,
		related: [],
		tags: ["comfyui","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Private MkDocs-backed specification hub for Cotton-West — an integrated club-management SaaS covering POS, member portal, public store, REPROCANN compliance, and full product traceability for Argentina (Mendoza focus). | | Audience | Internal kodexArg engineers and agents implementing Cotton-West; club administrators and operators (future end users); compliance officers; auditors and health inspectors (future report consumers). | **Naming note:** README and still reference a public sibling name and a GitHub Pages destination under the kodexArg org. The swarm assignment targets the **private** repo slug . Treat as the canonical private spec vault; the public docs mirror may live under a differently named repository.`,
		related: [],
		tags: ["cotton","github","private","high","summary"],
		visibility: "private",
		importance: "high",
	...
	},
	{
		...
		text: `### 3.1 North-star use cases (hypothetical — not evidenced in tree) 1. **Promote or mirror:** Operator initializes the repo by pushing content from or when the cotton-prefixed name becomes canonical. 2. **Client handoff boundary:** Reserved private repo for Coveris-specific deliverables under the cotton client namespace, distinct from the broader parent repo. 3. **Agent inventory:** RAG swarm includes this file so queries about resolve to "placeholder" instead of hallucinating a tech stack.`,
		related: [],
		tags: ["cotton-coveris","github","private","low","summary"],
		visibility: "private",
		importance: "low",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Healthcare capacity-planning SaaS that measures live demand-vs-supply across a clinic organigram and supports assignment, coverage, hours, scheduling, and payroll-adjacent workflows. | | Audience | Clinic HR managers (“Jefe” / MANAGER), operational staff (“Agente” / EMPLOYEE), auditors (AUDITOR), platform admins (ADMIN, internal), developers and AI agents maintaining the stack. |`,
		related: [],
		tags: ["cotton-coveris-mvp","github","private","high","summary"],
		visibility: "private",
		importance: "high",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Real-time staffing gap measurement and assignment tooling for mid-size private clinics, built on a demand/offer domain model over a hierarchical org chart. | | Audience | Clinic HR managers, service chiefs, auditors, and employees (role-scoped); internal developers and AI agents maintaining the stack; operators deploying to Cloudflare. |`,
		related: [],
		tags: ["coveris","github","private","high","summary"],
		visibility: "private",
		importance: "high",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Browser-based random character creator and scenario reference for the SyV tabletop RPG, with save/load via pickle files. | | Audience | Game masters and players of *Subordinación y Valor* who need NPCs, quick PCs, or on-screen scenario notes during play. |`,
		related: [],
		tags: ["creadorpj","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `### P3 — Scenario reference scattered outside the play session - **Who hurts:** GMs running published or draft SyV scenarios who need location prose, NPC roster blurbs, and sample dialogue at hand. - **Pain today:** Lore and scenario text may live in separate design repos or notebooks; switching context mid-session breaks pacing. - **How this repo answers:** embeds multiple named scenarios (e.g. asylum, hotel, embassy, police/intelligence sites, sewer basements) with structured fields: (paragraph array), (name → description lines), and (name → quote lines). The route and template provide a dropdown browser. is shown via for geographic orientation. - **Out of scope:** Dynamic state tracking for scenario progression, combat resolution, or the WEGO turn engine documented in .`,
		related: [],
		tags: ["creadorpj","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 3. Product / idea The mental model is **"single Flask app + JSON/CSV data lake + Jinja UI"**. There is no separate API service or database server — persistence is flat pickle files under . The navbar brands the app as *Subordinación y Valor* and exposes three PNJ workflows (Generar, Cargar, Guardar) plus Mapa.`,
		related: [],
		tags: ["creadorpj","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `### P2 — No live reference for agents and humans - **Who hurts:** Developers and coding agents who need to see components in context before copying or syncing them. - **Pain today:** Token files alone do not show motion, hover warmth, reduced-motion behavior, or constellation layout patterns. Agents hallucinate drift-prone CSS. - **How this repo answers:** A fully static Astro site renders brand, components, color scales, and type specimens. demonstrates the prompt mark (monospace voice, block cursor blink, warm hairline underline, exact casing). demonstrates drifting links that "warm up like a candle" on hover with orange glow and timing. Islands hydrate only where interactivity matters ( ). - **Out of scope:** Storybook, Figma sync, automated visual regression, or interactive token editors.`,
		related: [],
		tags: ["design.kodexarg.com","github","private","high","summary"],
		visibility: "private",
		importance: "high",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Self-hosted Django survey CRUD plus Google OAuth WiFi portal, with an experimental named-pipe bridge for host iptables control. | | Audience | Internal operators running a WiFi hotspot or visitor intake kiosk; developers maintaining a minimal Django stack in Docker; not intended as a production-hardened SaaS replacement without significant security work. |`,
		related: [],
		tags: ["dj-crudo","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Server-rendered Django inventory + POS with Cotton components, HTMX interactivity, and AWS App Runner deployment. | | Audience | Internal operators and counter staff at a retail location; developers and AI agents maintaining the stack; deployers configuring App Runner and RDS secrets. |`,
		related: [],
		tags: ["dj-west","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `# KM 1151 Enterprise Portal > **Problem thesis (required):** This repository is a Django web application for **KM 1151**, a fuel-station enterprise serving B2B fleet customers in Argentina. It digitizes the workflow from **fuel order creation** (by authenticated company users via social login) through **QR-based handoff** to **pump operators** who record refueling on a staff intranet, plus a parallel **ExtraCash** (cash transfer) module. The README explicitly marks the project as **work in progress and not production-ready**, but substantial modules (orders, vehicles, company, staff refueling, i18n, CI/CD hooks) are already implemented.`,
		related: [],
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Internal Django portal for casino-floor staff: announcements, HR novedades, temperature charts, and slot production tables. | | Audience | MCE staff (HR, operations analysts, floor supervisors), authenticated via Django users; admin users manage master data. |`,
		related: [],
		tags: ["djangomce","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `# KM 1151 Enterprise Portal (docker-kmportal) > **Problem thesis (required):** This repository packages and delivers a Django-based enterprise web portal for KM 1151, an Argentine fuel station serving B2B fleet customers. It solves the operational gap between fleet dispatchers (who need to order fuel loads across tractor, backpack, and chamber tanks for specific drivers and plates) and on-site pump operators (who need a staff intranet to fulfill those orders via QR scanning and refueling records). The repo unifies the application source, Docker build/runtime configuration, and deployment scaffolding so the portal can be developed locally and deployed to EC2 with a consistent MySQL-backed stack.`,
		related: [],
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Containerized Django portal for B2B fuel load ordering, ExtraCash transfers, and pump-operator fulfillment at KM 1151. | | Audience | B2B fleet customer users (OAuth login), pump operators (staff intranet), Django admins, and internal operators deploying to EC2. |`,
		related: [],
		tags: ["docker-kmportal","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Canonical MkDocs site plus Python tooling that documents and orchestrates ALVS v3 AWS infrastructure (DEV+PROD VPCs, ECS, RDS, Cognito, OIDC CI/CD) for projects. | | Audience | ALVS admins and architects (infra ownership), project developers (CI/CD and Django conventions), and AI agents editing or consuming the spec ( , ). |`,
		related: [],
		tags: ["docs-new-infra-grupoalvs-com","github","private","high","summary"],
		visibility: "private",
		importance: "high",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Compile Obsidian vaults to static HTML, deploy each vault and a shared portal index behind Cloudflare Access, with one wildcard auth policy covering all docs subdomains. | | Audience | Primary operator (Gabriel Cavedal); AI agents maintaining vaults and deployment; readers of hosted documentation after Google login. |`,
		related: [],
		tags: ["docs-portal","github","private","high","summary"],
		visibility: "private",
		importance: "high",
	...
	},
	{
		...
		text: `### P4 — Agent-assisted vault authoring needs conventions - **Who hurts:** AI agents editing Obsidian vaults or deploying docs who need syntax and Cloudflare deployment guardrails. - **How this repo answers:** bundles Obsidian markdown reference, Obsidian bases, Cloudflare wrangler/workers skills (vendor tree), find-skills, and skill-creator tooling. Vaults like ship their own with editorial policy (rolling-release PRDs, schema sync rules, lore canon boundaries). - **Out of scope:** The repo does not run agents; it only stores instruction trees.`,
		related: [],
		tags: ["docs-portal","github","private","high","summary"],
		visibility: "private",
		importance: "high",
	...
	},
	{
		...
		text: `# dollar-today-km1151 > **Problem thesis (required):** dollar-today-km1151 is an **on-work Python prototype** for a **marquesina** (marquee / signboard) that shows current currency exchange rates — especially Argentine peso–dollar variants and related pairs. The repo attacks the pain of manually updating a visual price board: it provides scripts to composite large numeric prices onto a shared background image and a stub toward fullscreen display, driven by a small JSON pricing file rather than a CMS or spreadsheet workflow.`,
		related: [],
	...
	},
	{
		...
		text: `### P2 — Fullscreen preview on a display PC - **Who hurts:** Whoever mounts a monitor or TV as the marquee and needs to verify background scaling before going live. - **Pain today:** Without a dedicated player, operators resize windows manually or rely on slideshow software unrelated to the price data. - **How this repo answers:** sketches an OpenCV fullscreen window ( , ) that loads and displays . The helper prepares pricing records for future overlay logic. - **Out of scope:** Completed integration between JSON prices and on-screen text (current body does not draw prices yet; the function definition appears incomplete in the tree).`,
		related: [],
		tags: ["dollar-today-km1151","github","private","low","summary"],
		visibility: "private",
		importance: "low",
	...
	},
	{
		...
		text: `### 3.1 North-star use cases 1. Operator runs , enters the day's dollar price, obtains for the marquee feed. 2. Operator edits with dated rates for several labels, runs display script (when complete) for fullscreen TV preview. 3. Developer swaps or adds alternate backgrounds ( , present) for seasonal branding.`,
		related: [],
		tags: ["dollar-today-km1151","github","private","low","summary"],
		visibility: "private",
		importance: "low",
	...
	},
	{
		...
		text: `# Flia > **Problem thesis (required):** Flia is a private, legacy Django application for **family household economics** — tracking articles (purchases and services), who is responsible, payment method, category, and dated payment amounts. It exists to give a small household a structured back-office (Django admin) instead of ad-hoc notes or spreadsheets, with Argentine Spanish labels and a data model sketched in before implementation.`,
		related: [],
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Django admin–backed family expense ledger with articles, categories, payers, payment types, and recurring amount history. | | Audience | Internal household operators (family members) entering and reviewing expenses via Django admin; originally built for personal/family use circa 2019. |`,
		related: [],
		tags: ["flia","github","private","low","summary"],
		visibility: "private",
		importance: "low",
	...
	},
	{
		...
		text: `# FSK Showers > **Problem thesis (required):** This repository is a small internal web application for registering and managing **shower usage** at a roadside fuel/highway service location in the Uspallata corridor (referenced in page metadata as KM1107 / KM1151). It replaces ad-hoc paper or spreadsheet tracking with a browser-based CRUD interface so on-site staff can create, list, and delete shower-use tickets while persisting records in MySQL.`,
		related: [],
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Flask + MySQL CRUD app for logging shower registrations at a highway fuel station, with Spanish operator UI. | | Audience | On-site operators and internal staff at the Uspallata-area facility; not a public consumer product. |`,
		related: [],
		tags: ["fsk-showers","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `### P1 — Manual shower-use tracking at a remote facility - **Who hurts:** Highway fuel-station operators and attendants who must record when customers use paid shower facilities. - **Pain today:** Paper logs or informal notes are hard to search, easy to lose, and do not tie cleanly to staff accountability or pricing plans. - **How this repo answers:** Provides a minimal Flask web UI ( , , ) backed by a relational schema ( , , , , ) so each shower session can be recorded and later listed or removed from a central database. - **Out of scope:** Payment processing, customer self-service portals, multi-site fleet management, reporting dashboards, or mobile-native apps.`,
		related: [],
		tags: ["fsk-showers","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Internal gym-member analytics toolkit: Oracle SQL + pandas/matplotlib reporting, with an unused Django admin shell for future GIC web tooling. | | Audience | Internal operators/analysts for a gym chain using Oracle-backed session tracking; original developer workstation paths suggest a single-maintainer dev setup. No agent harness or external consumer docs exist. |`,
		related: [],
		tags: ["gitcon","github","private","low","summary"],
		visibility: "private",
		importance: "low",
	...
	},
	{
		...
		text: `### P2 — PDF chart prototyping for reports - **Who hurts:** Someone exploring printable gym reports mixing narrative text and charts. - **Pain today:** Matplotlib alone does not produce polished PDF documents with embedded vector charts and legends in a single pipeline. - **How this repo answers:** demonstrates **ReportLab** flowables with an inline pie chart, legend, and before/after paragraphs. A sample output artifact is committed as evidence of a successful run (April 2019 timestamp in PDF metadata). - **Out of scope:** Production report templates, scheduled PDF generation, or integration with live Oracle data — the example uses static numeric data only.`,
		related: [],
		tags: ["gitcon","github","private","low","summary"],
		visibility: "private",
		importance: "low",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | The Kimi-native triage-and-fix party: eighteen agent cast definitions, one orchestration skill, and a Python CLI that manages PR requirement labels and defer cascades. | | Audience | Operators running Kimi Code CLI against kodexArg repos; the main Kimi agent executing the skill; developers vendoring the optional GitHub Actions cascade workflow. |`,
		related: [],
		tags: ["harness-triage-party","github","private","high","summary"],
		visibility: "private",
		importance: "high",
	...
	},
	{
		...
		text: `# kcbd-monitor > **Problem thesis (required):** kcbd-monitor exists to replace a production legacy indoor-environment monitoring system with a **decoupled, secure, headless architecture** that continuously ingests IoT sensor readings (temperature, humidity, light, substrate), stores them as durable time series grouped by cultivation room, and surfaces live dashboards plus historical charts — including derived agronomic indicators like Vapor Pressure Deficit (VPD) — so growers and technicians can see whole-facility state at a glance, spot drifts before crop damage, and trust that only authorized devices can write data. The refactor preserves the legacy domain logic while eliminating the monolith's security and scalability risks.`,
		related: [],
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Private Coveris documentation portal (bilingual markdown browser + PrimeNG showcase) bundled with a senior-QA audit toolkit and agent skill lockfile. | | Audience | Coveris developers, technical writers, AI coding agents ( , , , ), and QA engineers running structured audits against Coveris or related frontends. |`,
		related: [],
		tags: ["kdx-ng-coveris-docs","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `### 3.1 North-star use cases 1. Operator uploads a promotional still, sets 15 seconds at 1920×1080, selects three RPi device folders, submits — ffmpeg runs, MP4 copies land in each folder, players sync within minutes. 2. Operator opens the Videos page to verify which clips are staged per device before a campaign goes live. 3. Operator uses the copy modal (partially wired) to duplicate a clip’s staging path reference toward another device folder.`,
		related: [],
		tags: ["multimedia-handler-for-rpi","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Django home multimedia manager for Raspberry Pi—upload, catalog, and list files through a simple Bootstrap-styled web UI backed by MySQL. | | Audience | Home operator / developer running a Pi on the LAN; internal kodexArg maintainer reviving or referencing legacy Pi services. |`,
		related: [],
		tags: ["pihome","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `# ProcesarOcupacion > **Problem thesis (required):** This repository automates retrieval of **casino device-occupation CSV files** that arrive as email attachments in a Mendoza Central monitoring mailbox. It exists so operators do not have to manually download, rename, and file daily occupancy reports and related session exports. The repo also retains a historical archive of downloaded CSV snapshots (late 2020 through early 2021) alongside the harvesting scripts.`,
		related: [],
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Python IMAP scripts that pull CSV occupation reports from a casino monitoring inbox, save attachments to disk, and move processed messages to a processed folder. | | Audience | Internal casino / ALVS operators, monitoring staff, and anyone maintaining Mendoza Central occupancy reporting workflows. |`,
		related: [],
		tags: ["procesarocupacion","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Web-based random PNJ generator for RyF's *Subordinación y Valor* dystopia, with save/load via pickle and a scenario lore browser. | | Audience | Game masters and players of the RyF tabletop system; Spanish-speaking RPG groups; internal hobby tooling within the kodexArg org. |`,
		related: [],
		tags: ["pycreadorpj","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Aplicación para controlar gastos personales y familiares de manera ordenada — a reserved private repo name and license shell for a future Python expense tracker. | | Audience | Intended end users: individuals and families managing household spending; intended developers: kodexArg maintainers who would implement the Python app. No agent harness or operator docs exist yet. |`,
		related: [],
		tags: ["pyfinanzaspersonales","github","private","low","summary"],
		visibility: "private",
		importance: "low",
	...
	},
	{
		...
		text: `### P1 — Disorderly personal and family expense tracking - **Who hurts:** Individuals and families who struggle to see where money goes across personal and shared household purchases. - **Pain today:** Expenses often live in bank apps, paper receipts, informal notes, or one-off spreadsheets without a single structured view, making month-over-month comparison and family budgeting harder than necessary. - **How this repo answers:** **Only at the level of stated intent** ( , GitHub description). The name and Spanish pitch imply a future application to record and organize gastos personales y familiares. No models, UI, import pipelines, or reporting code exist in the tree to deliver that capability yet. - **Out of scope (today):** Tax filing, investment portfolio management, multi-currency trading, business accounting, bank API integration, and any deployed service — none are present in the repository.`,
		related: [],
		tags: ["pyfinanzaspersonales","github","private","low","summary"],
		visibility: "private",
		importance: "low",
	...
	},
	{
		...
		text: `### P2 — Isolated project home for a Python finance utility - **Who hurts:** A maintainer who wants a clean, licensable Python project boundary rather than embedding personal-finance experiments inside larger kodexArg apps. - **Pain today:** Without a dedicated repo, experiments risk polluting unrelated codebases or lacking a clear license and ignore rules for Python artifacts. - **How this repo answers:** Provides a **private GitHub home** with GPL-3.0 licensing and a Python-oriented (virtualenvs, , Django , , test caches, packaging artifacts). This establishes conventions for a future Python stack but does not yet include , , or application entrypoints. - **Out of scope:** Shared infrastructure with or other ALVS harness repos; no cross-repo links or submodule references were found.`,
		related: [],
		tags: ["pyfinanzaspersonales","github","private","low","summary"],
		visibility: "private",
		importance: "low",
	...
	},
	{
		...
		text: `### 3.1 North-star use cases (intended, not implemented) 1. **Record an expense** — user enters amount, date, category, and optional note for a personal or shared family purchase. 2. **Review by period** — user views monthly or weekly totals to understand spending habits. 3. **Family visibility** — multiple household members’ transactions roll up into a shared orderly view (implied by “familiares” in the pitch).`,
		related: [],
		tags: ["pyfinanzaspersonales","github","private","low","summary"],
		visibility: "private",
		importance: "low",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Fetch slot occupancy CSVs from email and merge them into a single Excel report for Mendoza casino floor monitoring. | | Audience | Internal casino operations / monitoring staff; whoever maintained the mailbox workflow circa 2021. |`,
		related: [],
		tags: ["pymceocup","github","private","low","summary"],
		visibility: "private",
		importance: "low",
	...
	},
	{
		...
		text: `### 3.1 North-star use cases 1. Operator runs after shift change to pull new occupancy CSV attachments and archive processed mail. 2. Analyst runs after CSVs are placed in to regenerate the master Excel occupancy sheet. 3. Supervisor opens (or individual CSVs) for floor utilization review.`,
		related: [],
		tags: ["pymceocup","github","private","low","summary"],
		visibility: "private",
		importance: "low",
	...
	},
	{
		...
		text: `# Detective Profession > **Problem thesis (required):** This repository preserves a **private Build 41 snapshot** of a Project Zomboid mod that adds a **Detective** playable profession. It exists to give cautious players a balanced urban-exploration specialist: strong indoor foraging, elevated vision, and a unique **danger-detection** loop that warns about zombies in small rooms—especially when the player toggles the game's search mode—while capping surprise so threats are never fully telegraphed. The GitHub description marks it as superseded by the **TrueDetective** rebuild for Build 42; this tree is the archived B41 lineage kept for reference and Workshop continuity.`,
		related: [],
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | A Project Zomboid mod that registers a Detective profession with urban foraging bonuses, fedora-and-trench-coat spawn gear, and door-adjacent zombie intuition voiced through randomized phrases. | | Audience | Project Zomboid players on Build 41, mod authors studying profession/forage hooks, and maintainers tracing the predecessor to the TrueDetective B42 rebuild. |`,
		related: [],
		tags: ["pz-detective-profession","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | A SvelteKit + Django stack that showcases SyV RPG characters as an interactive card carousel and serves them via a REST API, with in-app RyF rules documentation. | | Audience | SyV players, game masters, and internal authors generating or curating characters for the setting; not a general-purpose RPG platform. |`,
		related: [],
		tags: ["ryf","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
	...
	},
	{
		...
		text: `## 1. Identity | Field | Value | |-------|-------| | Org / repo | | | Visibility | | | Default branch | | | One-line pitch | Platform-agnostic Obsidian vault of WEGO wargame rules, JSON schemas, mathematical foundations, and Patagonian lore for *Subordinación y Valor*. | | Audience | Game designers and rule authors; AI agents acting as "Diseñador de Sistemas de Juego y Arquitecto Conceptual" per ; future engine implementers who need schemas and reglamento as SSOT. |`,
		related: [],
		tags: ["syv-game-system","github","private","normal","summary"],
		visibility: "private",
		importance: "normal",
